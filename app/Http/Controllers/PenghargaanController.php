...
class PenghargaanController extends Controller
{
	...
	public function index()
	{
		...
		$penghargaan1= Penghargaan::where('kode_penghargaan','LIKE', "i.%")->get();
		$penghargaan2= Penghargaan::where('kode_penghargaan','LIKE', "ii.%")->get();
		$penghargaan3= Penghargaan::where('kode_penghargaan','LIKE', "iii.%")->get();
